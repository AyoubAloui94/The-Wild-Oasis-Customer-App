...
function ReservationForm({ cabin, user }) {
  ...
  const createReservationBound = createReservation.bind(null, bookingData)
  ...
  return (
    <div className="scale-[1.01]">
      ...
      >
        ...
        <div className="flex justify-end items-center gap-6">{!startDate || !endDate ? <p className="text-primary-300 text-base">Start by selecting dates</p> : <SubmitButton>Reserve now</SubmitButton>}</div>
      </form>
    </div>
  )
}
